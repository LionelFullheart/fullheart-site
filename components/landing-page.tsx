            ...
            <div className="topbar">
              <div className="brand">
                ...
                <div className="brand-copy">
                  ...
                  <span>Software intake and deployment funnel</span>
                </div>
              </div>
              <a className="topbar-link" href="#intake">
                Start Your Project
              </a>
            </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-inner">
            <span>FullHeart Limited LLC</span>
            <span>Software Development and Deployment Intake</span>
          </div>
        </div>
      </footer>
    </main>
